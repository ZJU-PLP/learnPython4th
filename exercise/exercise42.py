# -*- coding: utf-8 -*-
# @Time    : 2018/7/5 0005 15:01
# @Author  : Lingpeng Peng
# @FileName: exercise42.py
# @Description: Class
...
class Game(object):
    ...
    def play(self):
        ...
        while True:
            print("\n-----------")
            room = getattr(self, next)  # getattr() 函数用于返回一个对象属性值。
            next = room()
    ...
    def central_corridor(self):
        ...
        if action == "shoot!":
            ...
            print("makes him fly into an insane range and blast you repeatedly in the face until")
            print("you are dead. Then he eats you.")
            return 'death'

        elif action == "dodge!":  # forget the ! when test
            print("Like a world class boxer your dodge, weave, slip and slide right.")
            print("as the Gothon's blaster cranks a laser past your head.")
            print("In the middle of your artful dodge your foot slips and you")
            print("bang your head on the metal wall and past out.")
            ...
            print("You tell the one Gothon joke you known:")
            print("Lbhe zbgure vf fb sng, jura fur fvgf nebhaq gur ubhfr, fur fvgf nebhaq gur buhfr.")
            print("The Gothen stops, tries not to launch, then busts out laughing and can't move.")
